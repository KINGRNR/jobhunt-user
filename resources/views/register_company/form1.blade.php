                        ...
                        <div class="pb-12 ml-8">
                            <div class="flex items-center">
                                <div class="flex items-center text-figma-biru-300 relative">
                                    <div class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-figma-biru-300">
                                ...
                                <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-figma-biru-300"></div>
                                <div class="flex items-center text-white relative">
                                    ...
                                    <div class="absolute top-0 -ml-10 text-center mt-16 w-32 text-sm font-medium  text-figma-biru-300">Company<br />Information</div>
                                </div>
                            ...
                            <div>
                                <div class="">
                                    <div class="grow grid grid-cols-1">
                                        <div class="grid grid-cols-1">
                                            <label for="email" class="block pb-2 text-sm font-medium text-gray-900">Company Name</label>
                                        ...
                                        <div class="grow grid grid-cols-1">
<label class="block pb-2 text-sm font-medium text-gray-900" for="file_input">Upload file</label>
<input class="block w-full text-sm text-gray-500 border border-gray-200 rounded-lg cursor-pointer focus:outline-none mb-4" id="file_input" type="file">
</div>

                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-6">
                                            <div class="grid grid-cols-1">
                                                <label for="email" class="block pb-2 text-sm font-medium text-gray-900">Website</label>
                                                <input type="text" id="email"
                                                class="mb-4 block w-full p-4 text-sm text-gray-900 border border-gray-200 rounded-lg focus:ring-blue-500 focus:border-blue-500"
