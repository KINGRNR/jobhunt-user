                        ...
                        <div class="pt-5">
                            <div class="pb-12 ml-8">
                                <div class="flex items-center">
                                    ...
                                    <div
                                        class="flex-auto border-t-2 transition duration-500 ease-in-out border-figma-biru-300">
                                    </div>
                                    <div class="flex items-center text-figma-biru-300 relative">
                                        <div
                                            class="rounded-full transition duration-500 ease-in-out h-12 w-12 py-3 border-2 border-figma-biru-300">
                            ...
                            <div class="mt-8 p-4">
                                <div>
                                    <div class="">
                                        <div class="grid grid-cols-1">
                                                <label for="email"
                                                    class="block pb-2 text-sm font-medium text-gray-900">Company
                                                    Name</label>
                                            ...
                                            <div class="grid grid-cols-1">
                                                <button type="button"
                                                    class="text-white bg-figma-biru-primary hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 block w-full">SIGN
                                                    UP</button>
                                            </div>
                                        </div>
                                    </div>
