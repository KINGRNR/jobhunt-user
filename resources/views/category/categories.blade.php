<div class="grid grid-cols-4">
    <div class="order-1 flex">
        <div class="bg-figma-agakbiru pr-36 max-h-[630px]">
            <div class="block ml-12 my-12">
                ...
                <div class="flex items-center mb-6">
                    <form id="filter-form" action="javascript:loadData(this)" method="post">
                        <input id="default-radio-1" type="radio" value="" name="job_type"
                ...
                <div class="flex items-center mb-6">
                    <input checked id="default-radio-2" type="radio" value="1" name="job_type"
                        class="w-4 h-4 text-figma-agakbiru bg-white border-white checked:ring-white checked:ring-2 duration-75">
            ...
            <button type="button" id="apply-filter-btn" class=" hover:underline focus:outline-none">
                Apply Filter
            </button>
        </form>
        </div>
        ...
        <div class="grid grid-cols-1">
            ...
            <div class="relative mx-8 mb-8">
                ...
                <input type="text" id="input-group-1"
                    class="bg-white border border-gray-300 text-gray-900 text-sm rounded-full focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-4 duration-100" onkeyup="searchJob()"
