            ...
            <article class="rounded-lg bg-white p-4 shadow-sm transition mb-6 hover:shadow-lg sm:p-6">
                ...
                <div class="grid grid-cols-1 lg:flex gap-6">
                    ...
                    <span
                        ...
                        <a href="" class="relative bg-gray-200 text-sm flex items-center justify-center font-medium w-36 h-14 lg:h-10 rounded" style=""><svg xmlns="http://www.w3.org/2000/svg" width="24" height="6" viewBox="0 0 24 6" fill="none">
