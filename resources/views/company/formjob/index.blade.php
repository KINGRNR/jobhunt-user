                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    ...
                                    <div class="flex justify-end">
                                        <button data-modal-hide="popup-modal" type="submit"
                                            class="text-white bg-figma-biru-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-gray-200 border-2 border-figma-biru-300 text-sm font-medium px-5 py-2.5 focus:z-10 w-[50%]">Preview</button>
                                    </div>
                                </div>
                        </div>
                    </article>
