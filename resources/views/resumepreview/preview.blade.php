...
<div class="parent">
    ...
    <div class="grid grid-cols-1 gap-2">
        <div class="flex justify-center">
            <p class="mt-28 font-semibold text-2xl">Crimson 1</p>
        </div>
        <div class="flex justify-center">
            <p class="font-medium">Panzerkampfwagen IV
                Sd.Kfz. 161</p>
        </div>
        <div class="flex justify-center">
            <p class="font-medium"><i class="fa fa-envelope-o"></i>&nbsp;blabla@mail.com</p>
        </div>
        <div class="flex justify-center">
            <p class="font-medium"><i class="fa fa-map-marker"></i>&nbsp;Stjarna Star System</p>
        </div>
    </div>
        ...
        <div class="grid grid-cols-6 ">
            <div class="col-span-4">
                <div class="mb-5 grid grid-cols-6 gap-4">
                    ...
                    <p class="col-span-5">Ratujuna Mahalika</p>
                </div>
                <div class="mb-5 grid grid-cols-6 gap-4">
                    <p class="text-gray-500">Email</p>
                    <p class="col-span-5">Ratujuna.Mahalika@gmal.com</p>
                </div>
                <div class="mb-5 grid grid-cols-6 gap-4">
                ...
                <div class="mb-5 grid grid-cols-6 gap-4">
                    ...
                    <p class="col-span-5">Perum Graha Gading Indah Blok A No 12</p>
                </div>
                <div class="mb-5 grid grid-cols-6 gap-4">
                    <p class="text-gray-500">Age</p>
                    <p class="col-span-5">22 Tahun</p>
                </div>
                <div class="mb-3 grid grid-cols-6 gap-4">
                    <p class="text-gray-500">Skills</p>
                    <p class="col-span-5">- Mastering several tools, such as Figma, Adobe Xd, Whimsical, and sketch</p>
                    <br>
                    <p class="col-span-5">- Mastering HTML and CSS programming languages</p>
                    <br>
                    <p class="col-span-5">- Mastering 3 foreign languages ​​namely English, Spanish, Korean</p>
                </div>
                <div class="mb-5 grid grid-cols-6 gap-4">
                    <p class="text-gray-500">Resume Content</p>
                    <p class="col-span-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras dignissim
                        sodales
                        ante nec laoreet. Maecenas at diam ut eros vestibulum tempor. Sed nec arcu ut est luctus
                        tristique.
                        Etiam in magna tristique, cursus nunc eu, ornare felis. Phasellus et imperdiet nisi. In nunc
                        sapien,
                        congue nec dignissim tempor, iaculis in sapien. Donec vel commodo nibh, nec placerat sem.</p>
                </div>
                <div class="mb-5 grid grid-cols-6 gap-4">
                    <p class="text-gray-500">Portofolio Link</p>
                    <p class="col-span-5">https://drive.google.com/folders/PORTOFOLIO</p>
                </div>
            </div>
                    ...
                    <article class="rounded-lg bg-white p-4 border border-black sm:p-6">
                        <div class="leading-8">
                            <div class="text-sm mb-5">
                                ...
                                <p class="ml-5 text-gray-600">Rp 1.000,00 - Rp. 2.000,00</p>
                            </div>
                            <div class="text-sm mb-5">
