        ...
        <div class="order-1">
            ...
            <div class="grid grid-cols-1">
                ...
                <div class="mx-8 lg:mx-28 py-6 flex justify-start">
                    <img src="http://0.0.0.0:8000/svg/logoipsum-287.svg" class="w-48 h-16" alt="HTML tutorial">
                </div>
                ...
                <div class="mx-12 lg:mx-32 w-50vh h-auto lg:w-[80vh]">
                    ...
                    <div class="grid grid-cols-1">
                        <button type="button"
                            class="text-white bg-figma-biru-primary hover:bg-blue-800 duration-100 focus:ring-4 focus:ring-blue-300 font-medium text-sm p-3 my-4">SIGN
                            IN</button>
                    </div>
                </div>
