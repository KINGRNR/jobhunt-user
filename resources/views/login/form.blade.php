            ...
            <div class="ml-24 flex justify-center">
                <div class="">
                    ...
                    <div class="grid grid-cols-2 gap-2 py-2">
                        <button type="button"
                            class="text-white bg-white border border-gray-200 hover:bg-gray-200 duration-100 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full px-3 py-3 text-center mr-2 mb-2 ml-48 flex justify-end"><svg
                            ...
                            <button type="button"
                            class="text-white bg-white border border-gray-200 hover:bg-gray-200 duration-100 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full px-3 py-3 text-center mb-2 mr-[200px] flex justify-end"><svg
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <g clip-path="url(#clip0_892_2065)">
                                    <path
