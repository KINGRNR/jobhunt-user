...
<div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-8 lg:px-6">
    <div class="mx-auto max-w-screen-sm text-center">
        <h2 class="text-3xl lg:text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Hello Pid
        </h2>
...
<section class="bg-white dark:bg-gray-900 flex flex-col lg:flex-row">
    <!-- Left Section (Profile Box) -->
    <div class="w-full lg:w-1/4 p-4 side-content"> <!-- Adjusted padding -->
    ...
    <div class="lg:flex-1 overflow-y-auto p-4">
