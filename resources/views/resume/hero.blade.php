<section
    ...
    <div class="bg-black bg-opacity-50 h-72">
        <div class="container flex flex-col justify-center p-6 mx-auto py-20 lg:flex-row lg:justify-between">
            <div
                class="text-white flex flex-col justify-center p-6 rounded-sm md:max-w-md xl:max-w-lg md:text-left">
                <p class="ml-0 font-poppins text-2xl font-semibold sm:text-3xl">Submit Resume
                </p>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                          <a href="/" class="inline-flex items-center text-xl font-medium text-gray-300">
                            <svg class="w-4 h-4 mr-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
