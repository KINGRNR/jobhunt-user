<section
    ...
    <div class="bg-black bg-opacity-50 h-72">
        <div class="container flex flex-col justify-center p-6 mx-auto lg:justify-between">
            ...
            <div class="z-40 shadow-lg">
                <article class="rounded-lg bg-white p-4 border border-black sm:p-6">
                    <div class="leading-8">
                        <div class="mb-5">
                            <p class="font-semibold text-2xl mb-2">Resume</p>
                            <p class="">ini masih belum selesai, kalau ada keluhan laporkan pada <span
                                    class="text-figma-biru-300">dapid</span>.</p>
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-8 mb-5">
                            ...
                            <div class="grid grid-cols-4">
                                ...
                                <div class="col-span-3">
                                    <select
                                        ...
                                        <option value="0">tes1</option>
                                        <option value="1">tes2</option>
                                        <option value="2">tes3</option>
                                        <option value="3">tes4</option>
                                    </select>
                                </div>
                            </div>
                            <div class="grid grid-cols-4">
                            ...
                            <div class="grid grid-cols-8 col-span-2">
                                <div class="text-sm">
                                    <p class="font-semibold">Skills <span
                                            class="text-figma-biru-300">(optional)</span></p>
                                </div>
                                <div class=" col-span-7">
                                    <input type="text" id="name" name="name"
                            ...
                            <div class="grid grid-cols-4">
                                <div class="text-sm">
                                    <p class="font-semibold">Candidate Gender <span
                                            class="text-figma-biru-300">(optional)</span></p>
                                </div>
                                <div class=" col-span-3">
                                    <input type="text" id="name" name="name"
                            ...
                            <div class="grid grid-cols-8 col-span-2">
                                ...
                                <div class="col-span-7">
                                    ...
                                    placeholder='sementara textarea dulu, WYSIWYG editornya ntar dulu -dapit' ></textarea>
                                </div>
                            </div>
                            <div class="grid grid-cols-8 col-span-2 mb-5">
                                <div class="text-sm">
                                    <p class="font-semibold">Portofolio <span
                                            class="text-figma-biru-300"></span></p>
                                </div>
                                <div class=" col-span-7">
                                    <input type="text" id="name" name="name"
                                        class=" block w-full p-4 text-sm text-gray-900 border border-gray-200 rounded-lg focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <button data-modal-hide="popup-modal" type="button" class="text-black bg-white focus:ring-4 focus:outline-none focus:ring-figma-biru-300 border-2 border-figma-biru-300 text-sm font-medium px-5 py-2.5 focus:z-10 w-[50%]">
                                Reset
                            </button>
                            </div>
                            <div class="flex justify-end">
                            <button data-modal-hide="popup-modal" type="button" class="text-white bg-figma-biru-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-gray-200 border-2 border-figma-biru-300 text-sm font-medium px-5 py-2.5 focus:z-10 w-[50%]">Preview</button>
                        </div>
                        </div>
                    </div>
                </article>
