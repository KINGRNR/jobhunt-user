    ...
    <div class="bg-black bg-opacity-50 h-72">
        <div class="container flex flex-col justify-center p-6 mx-auto py-20 lg:py-24 lg:flex-row lg:justify-between">
            <div
                ...
                <p class="ml-0 font-poppins text-2xl font-semibold sm:text-3xl">Riwayat Lamaran
                </p>
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        ...
                        <li>
                          <div class="flex items-center">
                            ...
                            <a href="#" class="ml-1 text-xl font-medium text-white md:ml-2">Riwayat Lamaran</a>
                          </div>
                        </li>
                      </ol>
                </div>
