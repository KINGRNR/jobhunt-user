<section id="hero-section"
    class="relative bg-[url(https://images.unsplash.com/photo-1572021335469-31706a17aaef?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8cGVvcGxlJTIwd29ya2luZ3xlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80)] bg-local bg-center bg-cover">
    <div class="bg-black bg-opacity-40 pb-0 lg-bigger:pt-20 lg-bigger:pl-32">
        <div class="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
            <div
                ...
                <span><svg class="absolute md:p-0 hidden md:inline" width="218" height="200" viewBox="0 0 218 200"
                ...
                <div
                    ...
                    <button type="button"
                        class="text-white bg-merah hover:bg-red-700 focus:ring-red-800 hover:duration-150 focus:ring-4 focus:outline-none font-medium text-sm px-4 py-3 text-center mr-3 md:mr-0"><i
