<nav class="text-black fixed top-0 left-0 right-0 bg-white duration-150 z-50">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <a href="/" class="flex items-center">
            <svg id="logo-77" width="105" height="40" viewBox="0 0 105 40" fill="black"
        ...
        <div class="flex md:order-2 space-x-4">
                            ...
                            <div class="p-6 text-center">
                                ...
                                <div class="flex justify-center gap-6">
                                    ...
                                    <a data-modal-hide="popup-modal" href="" id="submit-resume"
                                        class="hidden text-black bg-figma-biru-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-gray-200 border-2 border-figma-biru-300 text-sm font-medium px-5 py-2.5 focus:z-10 w-full">Use
                                        Resume</a>
                                </div>
                            </div>
                        </div>
            ...
            @else
                <button type="button" onclick="window.location='{{ route('register') }}'"
                    class="hidden min-[450px]:inline text-black bg-transparent border border-white hover:bg-white hover:text-black hover:border-transparent focus:ring-white hover:duration-150 focus:ring-4 focus:outline-none font-medium text-sm px-4 py-2 text-center mr-0">Daftar</button>
        ...
        <div class="items-center hidden w-full md:flex md:w-auto md:order-1 md:flex-grow flex-row justify-end md:px-8"
            ...
            <ul
                ...
                @endguest
                <li>
                    <a href="#motivasi" class="block py-2 pl-3 pr-4 text-black md:p-0 hover-underline-animation"
                        aria-current="page">Home</a>
                </li>
                <li>
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                        class="flex items-center justify-between w-full py-2 pl-3 pr-4  text-black md:border-0 md:p-0 md:w-auto hover-underline-animation">Job
                        List <svg class="w-5 h-5 ml-1" aria-hidden="true" fill="black" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                                d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                                clip-rule="evenodd" fill="black"></path>
                        </svg></button>
                    <!-- Dropdown menu -->
                    <div id="dropdownNavbar"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400"
                            ...
                            <li class="">
                                <a href="#"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">Dashboard</a>
                            </li>
                            <li>
                                <a href="#"
                            ...
                            <li>
                                <a href="#"
                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-black">Earnings</a>
                            </li>
                        </ul>
                        @auth
                            <div class="py-1">
