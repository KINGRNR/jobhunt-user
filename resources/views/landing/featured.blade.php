...
<div class="grid grid-cols-1 m-12">
    <article class="rounded-lg bg-white p-4 shadow-sm transition mb-6 hover:shadow-lg sm:p-6 animate-left-featured">
    ...
    <article class="rounded-lg bg-white p-4 shadow-sm transition mb-6 hover:shadow-lg sm:p-6 animate-right-featured">

        <div class="grid grid-cols-1 lg:flex gap-6">
            <span class="flex-none justify-start">
                <img src="/file/job_logo/fedev.jpg" alt="">
            </span>
            ...
            <span
                class="relative bg-figma-blue-gray-50 text-blue-800 text-sm flex items-center justify-center font-medium w-36 h-14 lg:h-10 rounded">Part
                Time</span>
            </a>
        </div>
    </article>
    ...
    <article class="rounded-lg bg-white p-4 shadow-sm transition mb-6 hover:shadow-lg sm:p-6 animate-left-featured">
        ...
        <div class="grid grid-cols-1 lg:flex gap-6">
            <span class="flex-none justify-start">
                <img src="/file/job_logo/dmarketing.jpg" alt="">
    ...
    <article class="rounded-lg bg-white p-4 shadow-sm transition mb-6 hover:shadow-lg sm:p-6 animate-right-featured">
        ...
        <div class="grid grid-cols-1 lg:flex gap-6">
            <span class="flex-none justify-start">
                <img src="/file/job_logo/construction.jpg" alt="">
    ...
    <article class="rounded-lg bg-white p-4 shadow-sm transition mb-6 hover:shadow-lg sm:p-6 animate-left-featured">
        ...
        <div class="grid grid-cols-1 lg:flex gap-6">
            <span class="flex-none justify-start">
                <img src="/file/job_logo/sales.jpg" alt="">
...
{{-- <script>
    $(document).scroll(function () {
        ...
        const articles = $('.animate-left-featured  , .animate-right-featured ');
