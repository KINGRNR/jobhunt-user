...
<section class="splide" aria-label="Splide Basic HTML Example">
          ...
          <ul class="mb-5 splide__list">
              ...
              <li class="splide__slide">
                <div class="mb-3 max-w-sm h-[492px] bg-white rounded-2xl shadow-[0_4px_20px_10px_rgba(82,109,130,0.05)]">
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-3 text-lg font-bold tracking-tight text-gray-900 dark:text-white">Winston Churchill</h5>
                        </a>
                        <p class="mb-3 text-sm font-normal">“We shall fight in France, we shall fight on the seas and oceans, we shall fight on the beaches, we shall fight on the landing grounds, We shall never surrender.”</p>
                    </div>
                </div>
              </li>
              <li class="splide__slide">
                <div class="mb-3 max-w-sm h-[492px] bg-white rounded-2xl shadow-[0_4px_20px_10px_rgba(82,109,130,0.05)]">
                    ...
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-3 text-lg font-bold tracking-tight text-gray-900 dark:text-white">Hirohito</h5>
                        </a>
                        <p class="mb-3 text-sm font-normal">“勝利の果実はあまりにも早く私たちの口に転がり込んでくる.”</p>
                    </div>
                </div>
              </li>
              <li class="splide__slide">
                <div class="mb-3 max-w-sm h-[492px] bg-whit rounded-2xl shadow-[0_4px_20px_10px_rgba(82,109,130,0.05)]">
                    ...
                    <div class="p-5">
                        ...
                        <p class="mb-3 text-sm font-normal">“He who would live must fight. He who doesn’t wish to fight in this world, where permanent struggle is the law of life, has not the right to exist.”</p>
                    </div>
                </div>
              </li>
              <li class="splide__slide">
  ...
  var items = getElementsByClassName("splide__pagination__page.is_active"); 
