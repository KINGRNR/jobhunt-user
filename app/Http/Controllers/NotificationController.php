...
class NotificationController extends BaseResponse
{
    ...
    public function index()
    {
        ...
        $notif = DB::table('notification')->where('notification_to', $id)->orderBy('notification_created_at', 'DESC')->get();
        // $notif['read'] = DB::table('notification')->where('notification_to', $id)->orderBy('notification_created_at', 'DESC')->where('notification_read', 1)->get();
